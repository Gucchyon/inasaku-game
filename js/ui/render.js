  ...
  function renderHelp(container) {
    ...
    wrap.innerHTML = `
      ...
      <div style="font-size:14px; line-height:1.7;">
        ...
        <h4 style="margin-top:14px; color:#6b5a1e;">📜 免責 (品種名について)</h4>
        <p style="font-size:12px; color:#6b5a1e; line-height:1.6;">
          本ゲームに登場する水稲品種名は、各登録機関・育成者・商標権者に帰属します。各品種の説明は公開情報（農水省・農研機構・各県農試・日本作物学会紀事など）に基づく一般的な特性記述で、商品の宣伝や推奨・関連性の主張ではありません。本ソフトウェアは作物学の英語学習を目的とした非営利の教育用ゲームです。
        </p>
        <p style="font-size:12px; color:#6b5a1e; line-height:1.6; margin-top:6px;">
          記述に誤りや権利上の問題があれば GitHub Issues 等でご連絡ください。
        </p>
      </div>
    `;
