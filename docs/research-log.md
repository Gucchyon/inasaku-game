...
## 2026-05-11 MAFF 水稲技術情報 取り込み (8回目)

### 出典
- 農林水産省「水稲技術情報」 https://www.maff.go.jp/j/seisan/gijutsuhasshin/techinfo/suitou.html
  - 134件の水稲栽培技術カテゴリ別 (土作り・播種・直播・施肥・病害虫・除草・収穫・調製・スマート農業・品種・排水対策・圃場準備等)
- MAFF PDF「水稲の生育ステージと主な農作業」 (suitou-2.pdf, 10p)
  https://www.maff.go.jp/j/seisan/gijutsuhasshin/techinfo/attach/pdf/suitou-2.pdf
  ＜参考資料＞: 新潟県「水稲栽培指針」、青森県「稲作改善指導要領」、宮城県「宮城の稲作指導指針」

### 追加した語彙: 44語 (`vocabulary_maff.js`)

| 区分 | 代表語 |
|---|---|
| 7つの栽培ポイント (9語) | 健苗、健苗育成、苗半作、ほ場の均平化、適期防除、病害虫発生予察、適期収穫、作付設計、肥培管理 |
| ほ場・土壌 (9語) | 地下水位、耕盤、減水深、作土の深さ、地力窒素、有効態りん酸、けい酸、漏水、漏生イネ |
| 育苗 (3語) | 乳苗、ムレ苗、覆土 |
| 移植・栽植 (4語) | 株間、1株苗数、植え付け深さ、欠株 |
| 雑草・除草 (3語) | 一発処理除草、畦塗り、保水力 |
| 害虫 (1語) | イネドロオイムシ |
| 登熟・収穫 (6語) | 黄化籾割合、早期落水、早刈り、青米、立毛胴割れ、穂軸 |
| 高温・カドミウム (3語) | 高温耐性品種、カドミウム移行、カドミウム吸収抑制 |
| 補助 (6語) | 深水管理、浅水管理、細茎化、多肥栽培、稲わらすき込み、浅耕 |

### 翻訳精度向上 (vocabulary_overrides.js)
MAFF 教科書準拠で 7語の訳・読みを補正:
- maximum tillering stage = 最高分げつ期 (さいこうぶんげつき)
- soil reduction = 土壌還元
- rooting / establishment = 活着 (かっちゃく)
- yellow ripe stage = 黄熟期 (おうじゅくき)
- deep water management = 深水管理 (ふかみずかんり)
- shallow water management = 浅水管理 (あさみずかんり)

### ゲーム機構の本格化

#### ヘルプ画面に「稲作 7つの栽培ポイント」セクション追加
土づくり・健苗育成・均平化・予察・水管理・適期収穫・低コスト化を一覧化。
出典名は表示せず、ゲーム内の栽培哲学として提示。

#### 田詳細画面の黄化籾割合表示
- 登熟期 (stage 4): GPに応じて 65%→85% を動的に推定表示
  「🌾 黄化籾割合: 約78%」
- 成熟期 (stage 5): 「🌾 黄化籾割合 85-90% — 収穫適期」
収穫適期判定の教科書的指標を可視化。
...
## 2026-05-10 紀事94巻継続読破 (7回目)

### 出典: 日本作物学会紀事 94巻4号 (2025)
J-STAGE「水稲」検索結果から代表4本を読破。
http://www.jstage.jst.go.jp/browse/jcs/94/4/_contents/-char/ja

| 論文ID | タイトル | 抽出語数 |
|---|---|---|
| 94_396 | コムギ・ダイズ・トウモロコシと比較した水稲の深播きにおける出芽性 (福嶌ら) | 4 |
| 94_408 | 水稲育苗箱全量基肥栽培と疎植栽培技術との組み合わせ (高橋ら) | 3 |
| 94_418 | 北海道の水稲品種が有する順化型低温耐性の評価とQTL検出 (提箸ら) | 5 |
| 94_425 | 北陸地域での水稲品種「にじのきらめき」の湛水直播栽培における多収条件 (大平ら) | 5 |

### 追加した語彙: 17語

| 分野 | 語 |
|---|---|
| 栽培管理 | 深播き、播種深度、分施、栽植密度、湛水直播、苗立ち本数 |
| 生育段階 | 出芽日数、幼苗生存率 |
| 形態 | 下胚軸 |
| 生理 | 低温順化、順化型低温耐性 |
| 育種 | 組換え自殖系統、QTL寄与率、耐倒伏性、短稈 |
| 土壌・肥料 | 全量基肥 |
| 収穫 | 多収性 |

すべて `source.type: "jcs_journal"` 付き、citation に DOI を含む。

## 2026-05-10 産地手引き取り込み (6回目)

### 出典
- **関川村「岩船まいすたあ塾テキスト 水稲栽培の基礎知識」** (37 ページ PDF)
  - 関川村・JAにいがた岩船南部営農センター・村上農業普及指導センター
  - http://www.vill.sekikawa.niigata.jp/file/info/norinkanko/umai-kome/maisutajuku-text/iwafune-maisutajuku-text_p1-37.pdf
  - 新潟県農林水産部「水稲栽培指針」を参考。播種〜収穫の暦に沿った詳細ガイド
- **大阪府立環境農林水産総合研究所「水稲栽培の手引き」** (Web)
  - https://www.knsk-osaka.jp/nourin/gijutsu/techinfo/tebiki/
  - 育苗期 (3 章) → 本田管理 (6 章) → 収穫期 (2 章) の構成

### 追加した語彙: 55語 (`vocabulary_textbooks_v2.js`)

| 区分 | 語数 | 代表語 |
|---|---|---|
| 種子・育苗 | 17 | 種子予措、塩水選、充実籾、温湯消毒、浸種、催芽、はと胸状態、苗ヤケ、不完全葉、第一葉鞘長、出芽期、緑化期、硬化期、稚苗、中苗、徒長苗、植え傷み |
| 分げつ・水管理 | 13 | 有効分げつ、無効分げつ、有効茎歩合、中干し、飽水管理、間断灌水、走り水、夜干し、溝切り、乾土効果、土壌還元、硫化水素障害、上根 |
| 施肥・穂肥 | 6 | 側条施肥、全層施肥、基肥一発型肥料、減数分裂期、幼穂、稈長 |
| 収穫・乾燥・調製 | 7 | 粗玄米重、精玄米重、玄米水分、脱ふ率、架干し、収穫適期、刈り遅れ |
| 病害虫 | 5 | 褐条病、もみ枯細菌病、苗立枯細菌病、苗立枯病、紋枯病、葉鞘腐敗病 |
| その他 | 7 | 葉齢、第一節間伸長期、収量構成要素、着色粒、砕粒、畦畔 |

### 既存語彙の精度向上 (`vocabulary_overrides.js`)
産地手引きで使われる正式な日本語訳・読みに約60語を補正：
- `panicle weight: 穂重` → 読み「ほじゅう」を追加
- `cracked grain: 胴割粒` → 「胴割れ粒」表記を併記
- `blast: いもち病` → 「稲熱病」併記、「いねねつびょう」読み
- `panicle initiation: 幼穂形成期` → 教科書準拠
- `mid-season drying: 中干し` → 「なかぼし」読み
- `panicle dressing: 穂肥` → 「ほごえ」「ほひ」両読み
- `head rice yield: 整粒歩合・整粒歩留り` → 業界標準訳に
- ほか約60語

### ゲーム機構の本格化
- **生育段階名を教科書準拠に**:
  - 旧: 種・苗・分げつ・出穂・登熟・収穫可
  - 新: **播種期・苗期・分げつ期・出穂期・登熟期・成熟期**
- **段階解説の追加**: 田詳細画面で各段階の作物学的解説を表示
  - 例「分げつ期。茎数が増え、最高分げつ期を迎えると中干しを開始。」

### 数値サマリ
- 総語彙数: 約1290 → **1371** (+82)
- vocabulary_textbooks (合計): 69 + 55 = **124語**
- 出典付き比率: 約94%
